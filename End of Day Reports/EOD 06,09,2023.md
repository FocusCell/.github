...
# Team Phoenix
## Progress of the Day
- Team lead Discussed valuable ideas about silk art and future projects with the boss during a productive meeting and Brainstormed 
  innovative strategies to enhance the company's operations and drive future growth.
-  team had a meeting session with TPM . According to the recommendations of TPM, we are going to incorporate KPI.
- Had a fruitful discussion with the team lead about focus pass issues and other matters.
- Attended a training session focused on GitHub to learn about its functionalities for effective project collaboration.
- Explored the training manual and completed a training session with Microsoft365.
- Team lead assigned tasks to every team member during a meeting session.
- Generated innovative ideas for silk art and future projects.
## Meeting Notes
[Meeting Notes](https://github.com/ayeshaafzal786/eod-notes/blob/main/README.md)
## Tomorrow Plans
- Continue brainstorming session on the project.
- Discuss the progress of assigned tasks.
- Plan next steps for the project.
- Evaluate the implementation of KPIs.
- Prepare for upcoming meetings and presentations.
# Team Nebula
## Progress of the Day
- Today, as a team, we made significant progress towards our project goals. Here are the key highlights:
- Maintain GitHub files such as EOD report, Meeting notes and Schedule table.
- Effectively attend TPM meeting.
- Scheduled a meeting with HR Team to discuss about multiple stuff such as
1-ORBITAL in Focus pass app
2- STAR importance
3-How to create a STAR
4-How to review the STAR by Katherine
5- Error In Focus Pass app after reviwing the STAR
- Collaborative meeting with team and discuss multiple stuff.
- Discussed about contribution in differet chats and in teams.
- Discussed about importance of clock in and clockout from MS teams and describe the description with today's agenda.
- Efectivley attend the TPM meeting
## Meeting Notes
HumeraAkram: [Meeting NOtes](https://github.com/Oktopods/Nebula/blob/main/Meeting%20Notes/6-9-2023.md)
MoizAbbasii: [Meeting Notes](https://github.com/Oktopods/Nebula/blob/cc6758838349e6332b860cedc5fb4c9928b03f86/Meeting%20Notes/am%2009-06-2023.md)
Seharjamil112: [Meeting Notes](https://github.com/Oktopods/Nebula/blob/442de48e9cdf19cbeb4e017b2dbc26e20604a920/Meeting%20Notes/SJ-06-09-2023%20.md)
## Tomprrow Plans
- Not provided
# Team Hurricane
## Progress of the Day:
...
## Meeting Notes
- [Meeting Ajia Shah]:[Meeting notes](https://github.com/Oktopods/Hurricane/blob/main/meeting%20notes/ajia.md)
- [Meeting Ayesha Malik]: NOt provided
- [Aleem Sultan]:Not provided
## Tomorrow Plans
- Not Provided
